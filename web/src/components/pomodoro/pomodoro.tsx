...
export function Pomodoro() {
    ...
    if (!loading && simulated && pomodoroSession) {
        ...
        return (
            <div className="w-full flex flex-col items-center justify-around pt-2 pb-3 px-4 bg-beige rounded-2xl shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)] mt-10 xl:mt-20">
                <TimerProgress
    ...
    return (
        <div className="w-full mt-20 flex flex-col py-10 px-20 bg-beige rounded-2xl shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
            <Loading />
        </div>
    );
}
